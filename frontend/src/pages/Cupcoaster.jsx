...
const Cupcoaster = () => {
  ...
  const [filteredCupcoasters, setFilteredCupcoasters] = useState([]);
  ...
  useEffect(() => {
    ...
    setFilteredCupcoasters(result);
  }, [searchQuery, sortBy, minPrice, maxPrice, selectedRating, cupcoasters]);
  ...
  return (
    <div className="cupcoaster-container">
      ...
      <div className="cupcoaster-content">
        ...
        {!loading && !error && filteredCupcoasters.length === 0 && (
          <div className="no-products">No products match your filters.</div>
        )}

        <div className="product-grid">
          {filteredCupcoasters.map((product) => (
