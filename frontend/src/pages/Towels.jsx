...
const Towels = () => {
  ...
  const [filteredTowels, setFilteredTowels] = useState([]);
  ...
  useEffect(() => {
    ...
    setFilteredTowels(result);
  }, [searchQuery, sortBy, minPrice, maxPrice, selectedRating, towels]);
