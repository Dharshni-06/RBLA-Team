...
const Paperfiles = () => {
  ...
  const [filteredPaperfiles, setFilteredPaperfiles] = useState([]);
  ...
  useEffect(() => {
    ...
    setFilteredPaperfiles(result);
  }, [searchQuery, sortBy, minPrice, maxPrice, selectedRating, paperfiles]);
  ...
  return (
    <div className="paperfiles-container">
      <div className="paperfiles-content">
        ...
        {!loading && !error && filteredPaperfiles.length === 0 && (
          <div className="no-products">No products match your filters.</div>
        )}

        <div className="product-grid">
          {filteredPaperfiles.map((product) => (
