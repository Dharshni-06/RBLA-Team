...
const Bedsheets = () => {
  ...
  const [filteredBedsheets, setFilteredBedsheets] = useState([]);
  ...
  useEffect(() => {
    ...
    setFilteredBedsheets(result);
  }, [searchQuery, sortBy, minPrice, maxPrice, selectedRating, bedsheets]);
  ...
  return (
    <div className="bedsheets-container">
      ...
      <div className="bedsheets-content">
        ...
        {!loading && !error && filteredBedsheets.length === 0 && (
